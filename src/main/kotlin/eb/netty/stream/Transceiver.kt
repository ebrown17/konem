...
class Transceiver<I>(protected val channelPort: Int) {
    ...
    protected val activeHandlers: ConcurrentHashMap<InetSocketAddress, Handler<I>> = ConcurrentHashMap()
    protected val channelReaders: ConcurrentHashMap<InetSocketAddress, ChannelReader> = ConcurrentHashMap()
    ...
    fun transmitMessage(addr: InetSocketAddress, message: I) {
        synchronized(activeLock) {
