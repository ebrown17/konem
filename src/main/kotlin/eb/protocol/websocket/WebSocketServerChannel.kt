...
import eb.netty.stream.server.ServerChannel
...
class WebSocketServerChannel(transceiver: WebSocketTransceiver, vararg webSocketPaths: String) : ServerChannel() {
    ...
    override fun initChannel(channel: SocketChannel) {
        ...
        pipeline.addLast(WebSocketPathHandler::class.java.name, WebSocketPathHandler(transceiver, channelIds, *webSocketPaths))
