...
// Source file: konemwiremessage.proto at 7:1
...
public final class KonemMessage extends Message<KonemMessage, KonemMessage.Builder> {
  public static final ProtoAdapter<KonemMessage> ADAPTER = new ProtoAdapter_KonemMessage();
  ...
  public KonemMessage(MessageType messageType, Unknown unknown, Status status, HeartBeat heartBeat, Data data) {
    this(messageType, unknown, status, heartBeat, data, ByteString.EMPTY);
  }

  public KonemMessage(MessageType messageType, Unknown unknown, Status status, HeartBeat heartBeat, Data data, ByteString unknownFields) {
  ...
  public boolean equals(Object other) {
    ...
    if (!(other instanceof KonemMessage)) return false;
    KonemMessage o = (KonemMessage) other;
  ...
  public String toString() {
    ...
    return builder.replace(0, 2, "KonemMessage{").append('}').toString();
  }

  public static final class Builder extends Message.Builder<KonemMessage, Builder> {
    ...
    @Override
    public KonemMessage build() {
      return new KonemMessage(messageType, unknown, status, heartBeat, data, super.buildUnknownFields());
    }
  }
  ...
  private static final class ProtoAdapter_KonemMessage extends ProtoAdapter<KonemMessage> {
    ProtoAdapter_KonemMessage() {
      super(FieldEncoding.LENGTH_DELIMITED, KonemMessage.class);
    }

    @Override
    public int encodedSize(KonemMessage value) {
    ...
    @Override
    public void encode(ProtoWriter writer, KonemMessage value) throws IOException {
    ...
    @Override
    public KonemMessage decode(ProtoReader reader) throws IOException {
      Builder builder = new Builder();
      long token = reader.beginMessage();
      for (int tag; (tag = reader.nextTag()) != -1;) {
        switch (tag) {
    ...
    @Override
    public KonemMessage redact(KonemMessage value) {
      Builder builder = value.newBuilder();
